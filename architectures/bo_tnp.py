...
class DecisionTNP_BO(TNP):
    ...
    def construct_input(self, batch):
        ...
        # concatenate all
        embedding_all = torch.cat([embedding_t, embedding_context,
    ...
    def forward(self, batch):
        ...
        decision_out = self.dec_predictor(decision_out)  # [batch_size, n_target, dim_y*2]
...
if __name__ == "__main__":
    decision_tnp = DecisionTNP_BO(3, 3, 64, 2, 2, 2, 64)
