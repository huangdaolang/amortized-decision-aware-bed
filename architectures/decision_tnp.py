...
class DecisionTNP(TNP):
    ...
    def construct_input(self, batch):
        ...
        # embedding_all = torch.cat([embedding_x_star, embedding_context,
        #                            embedding_query, embedding_target], dim=1)  # without t
    ...
    def create_mask(self, context_x, query_x):
        ...
        num_global = 2  # 1 for t, another 1 for x*
        ...
        # Target Data
        # mask[2 + num_context + num_query:, 0:2] = 0  # TD attend GI
    ...
    def forward(self, batch):
        ...
        query_out = self.af_predictor(query_out)
        decision_out = self.dec_predictor(decision_out)  # [batch_size, n_decision, dim_y*2]
    ...
    def predict(self, batch):
        ...
        query_out = self.dec_predictor(query_out)
        decision_out = self.dec_predictor(decision_out)  # [batch_size, n_decision, dim_y*2]
        outs = AttrDict(query_out=query_out, decision_out=decision_out)
...
if __name__ == "__main__":
    decision_tnp = DecisionTNP(3, 3, 64, 2, 2, 2, 64, 3)
